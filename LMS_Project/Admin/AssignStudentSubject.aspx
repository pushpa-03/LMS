...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-5">
        ...
        <div class="card shadow-sm border-0 rounded-4 mb-4">
            ...
            <%-- Subject Pager — static buttons, always in DOM --%>
            <asp:Panel ID="pnlSubjPager" runat="server" Visible="false"
                CssClass="d-flex align-items-center justify-content-between px-3 py-2 border-top">
                <asp:Button ID="btnSubjPrev" runat="server" Text="‹ Prev"
                    CssClass="ass-page-btn" OnClick="SubjPrev_Click" CausesValidation="false" />
                <asp:Label  ID="lblSubjPage" runat="server" CssClass="text-muted small" />
                <asp:Button ID="btnSubjNext" runat="server" Text="Next ›"
                    CssClass="ass-page-btn" OnClick="SubjNext_Click" CausesValidation="false" />
            </asp:Panel>
    ...
    <div class="col-12 col-lg-7">
        ...
        <div class="card shadow-sm border-0 rounded-4 mb-4">
            ...
            <%-- Student Pager — static buttons --%>
            <asp:Panel ID="pnlStudPager" runat="server" Visible="false"
                CssClass="d-flex align-items-center justify-content-between px-3 py-2 border-top">
                <asp:Button ID="btnStudPrev" runat="server" Text="‹ Prev"
                    CssClass="ass-page-btn" OnClick="StudPrev_Click" CausesValidation="false" />
                <asp:Label  ID="lblStudPage" runat="server" CssClass="text-muted small" />
                <asp:Button ID="btnStudNext" runat="server" Text="Next ›"
                    CssClass="ass-page-btn" OnClick="StudNext_Click" CausesValidation="false" />
            </asp:Panel>
        </div>
        ...
        <%-- ══ TRACKER PAGER — fully static, always in DOM ══ --%>
        <%-- Navigation: First/Prev / numbered pages 1-N / Next/Last --%>
        <%-- Visibility and enabled-state are controlled from code-behind --%>
        <asp:Panel ID="pnlTrackerPager" runat="server" Visible="false"
            CssClass="d-flex align-items-center gap-2 flex-wrap justify-content-center mt-3">

            <asp:Button ID="btnTrkFirst" runat="server" Text="«" CssClass="ass-page-btn"
                OnClick="TrkFirst_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkPrev"  runat="server" Text="‹" CssClass="ass-page-btn"
                OnClick="TrkPrev_Click"  CausesValidation="false" />

            <%-- Up to 10 numbered page buttons; hide extras in code-behind --%>
            <asp:Button ID="btnTrkP1"  runat="server" Text="1"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP2"  runat="server" Text="2"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP3"  runat="server" Text="3"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP4"  runat="server" Text="4"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP5"  runat="server" Text="5"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP6"  runat="server" Text="6"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP7"  runat="server" Text="7"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP8"  runat="server" Text="8"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP9"  runat="server" Text="9"  CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />
            <asp:Button ID="btnTrkP10" runat="server" Text="10" CssClass="ass-page-btn" OnClick="TrkPage_Click" CausesValidation="false" />

            <asp:Button ID="btnTrkNext" runat="server" Text="›" CssClass="ass-page-btn"
                OnClick="TrkNext_Click"  CausesValidation="false" />
            <asp:Button ID="btnTrkLast" runat="server" Text="»" CssClass="ass-page-btn"
                OnClick="TrkLast_Click"  CausesValidation="false" />

            <asp:Label ID="lblTrackerPage" runat="server" CssClass="text-muted small ms-2" />
        </asp:Panel>
...
<script>
    ...
    function collectAndConfirm() {
        ...
        rows.forEach(function (row) {
            ...
            var chk = firstCell.querySelector('input[type="checkbox"]');
            var hf  = firstCell.querySelector('input[type="hidden"]');
            if (chk && chk.checked && hf && hf.value) ids.push(hf.value);
        });

        if (ids.length === 0) { showToast('Please tick at least one subject checkbox.', 'warning'); return false; }
        hfEl.value = ids.join(',');
        return confirm('Assign ' + ids.length + ' subject(s) to all students in this class?\n\nStudents already assigned will be skipped automatically.');
    }
