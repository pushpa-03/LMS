...
namespace LMS_Project.Student
{
    public partial class MySubjects : System.Web.UI.Page
    {
        ...
        // ============================================================
        // NEW: Video progress percentage helper — called from ASPX Repeater
        // Returns 0 when VideoCount is 0 to avoid divide-by-zero.
        // ============================================================
        protected int GetVideoPct(int watchedVideos, int totalVideos)
        {
            if (totalVideos <= 0) return 0;
            return (int)((double)watchedVideos / totalVideos * 100);
        }
    }
}