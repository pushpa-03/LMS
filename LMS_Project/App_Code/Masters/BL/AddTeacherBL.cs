...
//    //this also used in TeachcerDetails page
...
{
    /// <summary>
    /// Business Logic Layer – Teacher Management.
    /// Uses DataLayer methods only: GetDataTable, ExecuteCMD, ExecuteTransaction.
    /// All multi-table operations (Insert, Update, Delete, Re-enrol) use
    /// ExecuteTransaction for full atomicity.
    /// </summary>
