<%@ Page Title="My Notifications" Language="C#"
    ...
    CodeBehind="Teacher_Notifications.aspx.cs"
    Inherits="LearningManagementSystem.Teacher.Notifications" %>

<asp:Content ID="cHead" ContentPlaceHolderID="head" runat="server">
<style>
:root{
  --p:#0d9488;--pl:#ccfbf1;--pd:#0f766e;
...
.banner{background:linear-gradient(135deg,#042f2e 0%,#0f766e 50%,#0d9488 100%);
...
.ni.unread{border-left:3px solid var(--p);background:#f0fdfa}
...
.na-read{background:#ccfbf1;color:var(--p)}
